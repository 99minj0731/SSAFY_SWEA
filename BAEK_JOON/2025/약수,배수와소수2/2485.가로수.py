...
# 각 거리만큼 저장을 해서, 그 숫자 값들의 최대공약수를 구함. ex. 2, 4, 6일 경우 2. 13 - 1 = 12, 12 % 2 = 6 6-N-1을 하면 정답   1 3 7 13 -> 1 3 5 7 9 11 13 7개가 필요한데 - N을 하면됨 
...
num_gcd = math.gcd(*difference)

result = ((nums[-1] - nums[0]) // num_gcd) + 1 -N
print(result)
